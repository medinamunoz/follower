...
class SummariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create summary" do
    assert_difference('Summary.count') do
      post summaries_url, params: { summary: { close_day: @summary.close_day, description: @summary.description, note: @summary.note, resolution: @summary.resolution, starting_day: @summary.starting_day, type: @summary.type } }
    end
  ...
  test "should update summary" do
    patch summary_url(@summary), params: { summary: { close_day: @summary.close_day, description: @summary.description, note: @summary.note, resolution: @summary.resolution, starting_day: @summary.starting_day, type: @summary.type } }
